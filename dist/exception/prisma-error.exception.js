...
exports.PrismaErrorException = void 0;
const client_1 = require("../src/generated/prisma/client");
class PrismaErrorException extends Error {
    constructor(error) {
        super(error.message);
    ...
    handleKnownRequestError(error) {
        ...
        switch (error.code) {
            ...
            case 'P2002': // Unique constraint failed
                this.statusCode = 409;
                this.message = `Unique constraint failed on the fields: ${error.meta?.target?.join(', ') || 'unknown'}`;
...
exports.PrismaErrorException = PrismaErrorException;
//# sourceMappingURL=prisma-error.exception.js.map