...
const report_excel_utility_1 = require("./report-excel.utility");
describe('Report Excel Utility', () => {
    ...
    it('should generate Excel-compatible base64 file result', () => {
        const result = (0, report_excel_utility_1.generateReportExcel)(sampleReport);
...
//# sourceMappingURL=report-excel.utility.test.js.map