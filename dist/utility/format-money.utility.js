...
exports.CURRENCIES = exports.parseFormattedNumber = exports.formatWithSymbol = exports.formatMoneyCompact = exports.formatNumber = exports.formatMoney = void 0;
const currency_types_1 = require("../types/currency.types");
Object.defineProperty(exports, "CURRENCIES", { enumerable: true, get: function () { return currency_types_1.CURRENCIES; } });
/**
...
const getCurrencyConfig = (currency) => {
    return currency_types_1.CURRENCIES[currency || DEFAULT_CURRENCY];
};
// ============================================
 ...
 */
const formatWithSymbol = (amount, symbol = 'Rp') => {
...
exports.default = {
    ...
    formatMoneyCompact: exports.formatMoneyCompact,
    formatWithSymbol: exports.formatWithSymbol,
    parseFormattedNumber: exports.parseFormattedNumber,
    CURRENCIES: currency_types_1.CURRENCIES,
};
//# sourceMappingURL=format-money.utility.js.map