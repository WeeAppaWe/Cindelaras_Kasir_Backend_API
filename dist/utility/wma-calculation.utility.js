...
exports.calculateWMAFromDataPoints = exports.calculateWMA = void 0;
/**
 ...
 */
const calculateWMA = (data, options = {}) => {
 ...
 */
const calculateWMAFromDataPoints = (dataPoints, options = {}) => {
    const { useLinearWeight = true } = options;
...
exports.calculateWMAFromDataPoints = calculateWMAFromDataPoints;
exports.default = {
    calculateWMA: exports.calculateWMA,
    calculateWMAFromDataPoints: exports.calculateWMAFromDataPoints,
};
//# sourceMappingURL=wma-calculation.utility.js.map