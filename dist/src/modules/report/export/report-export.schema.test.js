...
const report_export_schema_1 = require("./report-export.schema");
describe('Report Export Schema', () => {
    ...
    describe('reportExportDataSchema', () => {
        it('should validate flexible report data', () => {
            const result = report_export_schema_1.reportExportDataSchema.parse(validReportData);
            expect(result.title).toBe('Laporan Finansial');
            expect(result.tables?.[0].rows).toHaveLength(2);
        });
        it('should reject empty report title', () => {
            expect(() => report_export_schema_1.reportExportDataSchema.parse({
                ...validReportData,
                title: '',
            })).toThrow();
        });
        it('should allow sections for nested report content', () => {
            const result = report_export_schema_1.reportExportDataSchema.parse({
    ...
    describe('reportExportTableSchema', () => {
        it('should reject table without columns', () => {
            expect(() => report_export_schema_1.reportExportTableSchema.parse({
                title: 'Invalid Table',
                columns: [],
                rows: [],
            })).toThrow();
    ...
    describe('export schemas', () => {
        it('should validate PDF export request', () => {
            const result = report_export_schema_1.exportReportPdfSchema.parse({
        ...
        it('should validate Excel export request', () => {
            const result = report_export_schema_1.exportReportExcelSchema.parse({
                data: validReportData,
                options: {
                    file_name: 'laporan-finansial',
...
//# sourceMappingURL=report-export.schema.test.js.map