...
const report_financial_schema_1 = require("./report-financial.schema");
describe('Report Financial Schemas', () => {
    ...
    describe('reportFilterSchema', () => {
        it('should validate valid date range', () => {
            const result = report_financial_schema_1.reportFilterSchema.safeParse({
    ...
    describe('topMenusQuerySchema', () => {
        it('should validate with limit parameter', () => {
            const result = report_financial_schema_1.topMenusQuerySchema.safeParse({
                start_date: '2026-01-01',
                end_date: '2026-01-31',
                limit: '10',
            });
...
//# sourceMappingURL=report-financial.schema.test.js.map