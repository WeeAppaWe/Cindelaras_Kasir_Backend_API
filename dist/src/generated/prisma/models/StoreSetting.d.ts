...
type GetStoreSettingGroupByPayload<T extends StoreSettingGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<StoreSettingGroupByOutputType, T['by']> & {
...
export type StoreSettingWhereInput = {
    ...
    store_setting_id?: Prisma.UuidFilter<"StoreSetting"> | string;
    setting_key?: Prisma.StringFilter<"StoreSetting"> | string;
    setting_value?: Prisma.StringFilter<"StoreSetting"> | string;
    created_at?: Prisma.DateTimeFilter<"StoreSetting"> | Date | string;
    updated_at?: Prisma.DateTimeNullableFilter<"StoreSetting"> | Date | string | null;
    deleted_at?: Prisma.DateTimeNullableFilter<"StoreSetting"> | Date | string | null;
};
export type StoreSettingOrderByWithRelationInput = {
    store_setting_id?: Prisma.SortOrder;
...
export type StoreSettingScalarWhereWithAggregatesInput = {
    ...
    store_setting_id?: Prisma.UuidWithAggregatesFilter<"StoreSetting"> | string;
    setting_key?: Prisma.StringWithAggregatesFilter<"StoreSetting"> | string;
    setting_value?: Prisma.StringWithAggregatesFilter<"StoreSetting"> | string;
    created_at?: Prisma.DateTimeWithAggregatesFilter<"StoreSetting"> | Date | string;
    updated_at?: Prisma.DateTimeNullableWithAggregatesFilter<"StoreSetting"> | Date | string | null;
    deleted_at?: Prisma.DateTimeNullableWithAggregatesFilter<"StoreSetting"> | Date | string | null;
};
...
export type StoreSettingUpdateInput = {
    store_setting_id?: Prisma.StringFieldUpdateOperationsInput | string;
...
export type StoreSettingOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"store_setting_id" | "setting_key" | "setting_value" | "created_at" | "updated_at" | "deleted_at", ExtArgs["result"]["storeSetting"]>;
...
export interface StoreSettingDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     *
     * // Only select the `store_setting_id`
     * const storeSettingWithStore_setting_idOnly = await prisma.storeSetting.findMany({ select: { store_setting_id: true } })
     *
     */
     ...
     * })
     *
     * // Create many StoreSettings and only return the `store_setting_id`
     * const storeSettingWithStore_setting_idOnly = await prisma.storeSetting.createManyAndReturn({
     *   select: { store_setting_id: true },
     *   data: [
     *     // ... provide data here
     *   ]
     * })
     ...
     * })
     *
     * // Update zero or more StoreSettings and only return the `store_setting_id`
     * const storeSettingWithStore_setting_idOnly = await prisma.storeSetting.updateManyAndReturn({
     *   select: { store_setting_id: true },
     *   where: {
     *     // ... provide filter here
     *   },
...
export interface StoreSettingFieldRefs {
    readonly store_setting_id: Prisma.FieldRef<"StoreSetting", 'String'>;
    readonly setting_key: Prisma.FieldRef<"StoreSetting", 'String'>;
    readonly setting_value: Prisma.FieldRef<"StoreSetting", 'String'>;
    readonly created_at: Prisma.FieldRef<"StoreSetting", 'DateTime'>;
    readonly updated_at: Prisma.FieldRef<"StoreSetting", 'DateTime'>;
    readonly deleted_at: Prisma.FieldRef<"StoreSetting", 'DateTime'>;
}
/**
