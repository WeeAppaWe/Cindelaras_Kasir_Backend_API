...
export const mockStockTypeIn: StockTypeData = {
    stock_type_id: 'aa0e8400-e29b-41d4-a716-446655440001',
    name: 'IN',
};

export const mockStockTypeOut: StockTypeData = {
    stock_type_id: 'aa0e8400-e29b-41d4-a716-446655440002',
    name: 'OUT',
};

export const mockStockTypes: StockTypeData[] = [mockStockTypeIn, mockStockTypeOut];

// ============================================
// INGREDIENT MOCK FOR INVENTORY
// ============================================

export const mockIngredientForInventory = {
...
export const mockSupplierForInventory = {
...
export const mockStockMovementIn: StockMovementWithDetails = {
...
export const mockStockMovementOut: StockMovementWithDetails = {
...
export const mockStockMovements: StockMovementWithDetails[] = [
    mockStockMovementIn,
...
export const createMockInventoryRequest = (overrides: {
