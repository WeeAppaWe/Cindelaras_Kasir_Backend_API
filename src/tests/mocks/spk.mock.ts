...
export const mockIngredientBeras = {
...
export const mockIngredientTelur = {
...
export const mockIngredientBumbu = {
...
export const mockRecipeBeras = {
    recipe_id: 'recipe-001',
    menu_id: 'menu-001',
    ingredient_id: 'ing-001',
    qty_needed: 0.2, // 200gr per porsi
    deleted_at: null,
    ingredient: mockIngredientBeras,
};

export const mockRecipeTelur = {
    recipe_id: 'recipe-002',
    menu_id: 'menu-001',
    ingredient_id: 'ing-002',
    qty_needed: 2, // 2 butir per porsi
    deleted_at: null,
    ingredient: mockIngredientTelur,
};
...
export const mockMenu = {
    ...
    name: 'Nasi Goreng',
    deleted_at: null,
    recipes: [mockRecipeBeras, mockRecipeTelur],
};
...
export const mockOrdersWithRecipes = [
    {
        order_id: 'order-001',
        created_at: new Date('2026-01-01T10:00:00Z'),
        status: 'COMPLETED',
        deleted_at: null,
        order_items: [{ ...mockOrderItem, qty: 10 }],
    },
    {
        order_id: 'order-002',
        ...
        status: 'COMPLETED',
        deleted_at: null,
        order_items: [{ ...mockOrderItem, qty: 15 }],
    },
    {
        order_id: 'order-003',
        ...
        status: 'COMPLETED',
        deleted_at: null,
        order_items: [{ ...mockOrderItem, qty: 20 }],
    },
    {
        order_id: 'order-004',
        ...
        status: 'COMPLETED',
        deleted_at: null,
        order_items: [{ ...mockOrderItem, qty: 25 }],
    },
    {
        order_id: 'order-005',
        ...
        status: 'COMPLETED',
        deleted_at: null,
        order_items: [{ ...mockOrderItem, qty: 30 }], // Tren naik
    },
];
...
export const expectedBerasWMA = 70 / 15; // ~4.67 kg/day
export const expectedTelurWMA = 700 / 15; // ~46.67 butir/day
