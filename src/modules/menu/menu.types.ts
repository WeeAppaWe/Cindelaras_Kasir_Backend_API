...
// Filter options for menu queries
...
// Menu data returned from database
...
// Menu with full details (including recipes count and cost summary)
...
// Menu detail response with recipes
