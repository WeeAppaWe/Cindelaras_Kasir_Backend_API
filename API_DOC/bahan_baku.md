...
| Proses | Field yang Dipakai |
| :--- | :--- |
| List/detail/low stock | `unit_measure_id`, `name` melalui relasi `unit`. |
...
## 2. Menampilkan Daftar Bahan Baku
...
## 6. Menghapus Bahan Baku (Soft Delete)
