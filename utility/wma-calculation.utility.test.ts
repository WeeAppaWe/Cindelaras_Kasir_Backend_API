import { calculateWMA, calculateWMAFromDataPoints } from './wma-calculation.utility';
...
describe('WMA Calculation Utility', () => {
    ...
    describe('calculateWMA', () => {
        ...
        it('should calculate linear weighted average correctly', () => {
            ...
            const result = calculateWMA([2, 3, 4, 5, 6]);
        ...
        it('should give higher weight to later elements', () => {
            ...
            const result = calculateWMA([10, 20]);
        ...
        it('should calculate equal weights when useLinearWeight is false', () => {
            ...
            const result = calculateWMA([10, 20], { useLinearWeight: false });
        ...
        it('should handle array with zeros', () => {
            ...
            const result = calculateWMA([0, 0, 10]);
            expect(result).toBe(5);
        });

        it('should handle all zeros', () => {
            const result = calculateWMA([0, 0, 0]);
            expect(result).toBe(0);
        });
        ...
        it('should handle decimal values', () => {
            ...
            const result = calculateWMA([1.5, 2.5]);
    ...
    describe('calculateWMAFromDataPoints', () => {
        it('should return zero result for empty array', () => {
            const result = calculateWMAFromDataPoints([]);
        ...
        it('should not modify original array', () => {
            ...
            calculateWMAFromDataPoints(original);
